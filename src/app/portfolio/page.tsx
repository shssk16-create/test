...
export default function Portfolio() {
  ...
  const projects = [
    { id: 1, title: "Aura Marketing", cat: "seo", img: "https://aurateam3.com/wp-content/uploads/2024/02/cropped-%D8%B4%D8%B9%D8%A7%D8%B1-%D8%A3%D9%88%D8%B1%D8%A7-02-2.png", role: "Full Platform Build", tech: ["SEO", "Web Development", "Analytics"], desc: "تأسيس كامل للمنصة مع بناء استراتيجية ظهور في محركات البحث.", impact: "المركز #1 في قوقل لـ 3 كلمات مفتاحية.", icon: Search },
    ...
    { id: 5, title: "Darb Stations", cat: "ui", img: "https://darbstations.com.sa/wp-content/uploads/2024/12/1221-copy-3.png", role: "UI/UX & Frontend", tech: ["UI/UX", "Frontend", "SEO Standards"], desc: "تصميم وهندسة صفحة المركز الإعلامي مع مراعاة تجربة المستخدم اللغوية.", impact: "واجهة إعلامية تتوافق مع أحدث معايير SEO.", icon: Layout }
  ];
