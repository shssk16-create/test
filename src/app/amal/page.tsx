      ...
      <nav className={`w-full h-20 z-50 px-4 md:px-12 flex items-center justify-between border-b ${
        ...
        <div className="flex gap-2 sm:gap-3 items-center shrink-0">
          <Link 
            ...
            className="flex items-center gap-2 bg-[#C2A56D] hover:bg-[#b39158] text-black px-4.5 sm:px-6 py-3 rounded-full text-xs sm:text-sm font-black shadow-[0_4px_15px_rgba(194,165,109,0.25)] hover:scale-[1.02] active:scale-[0.98] active:translate-y-[1px] transition-all duration-300"
          >
            <Sparkles size={14} />
